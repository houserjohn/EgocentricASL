...
def update_plot(frame, all_frame_points, scat, lines, hand_lines_left, hand_lines_right):
    ...
    if pose_points is not None:
        ...
        for i in [32, 30, 28, 31, 29, 27, 26, 24, 25, 23, 18, 20, 22, 21, 19, 17, 11, 12, 10, 9, 7, 3, 2, 1, 4, 5, 6, 8]:
            pose_points[i, :] = (-inf, -inf, -inf)
        pose_points[0, :] = (0, -40, 0) # have to treat the nose differently for some reason to get the points to display
